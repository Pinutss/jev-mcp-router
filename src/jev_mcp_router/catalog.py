"""Catalogue multi-LLM : choisir le juge sans mettre de cles dans les requetes."""
...
PRESETS: dict[str, dict[str, Any]] = {
    "openrouter": {
        ...
        "models": (
            {"id": "anthropic/claude-sonnet-4", "quality": 0.95, "cost": 0.55, "latency": 0.45},
            {"id": "anthropic/claude-3.5-sonnet", "quality": 0.90, "cost": 0.50, "latency": 0.40},
            {"id": "openai/gpt-4o-mini", "quality": 0.78, "cost": 0.12, "latency": 0.22},
            {"id": "google/gemini-2.0-flash", "quality": 0.82, "cost": 0.18, "latency": 0.20},
        ),
    },
    "openai": {
        ...
        "models": (
            {"id": "gpt-4o", "quality": 0.92, "cost": 0.70, "latency": 0.40},
            {"id": "gpt-4o-mini", "quality": 0.78, "cost": 0.15, "latency": 0.20},
        ),
    },
    "groq": {
        ...
        "models": (
            {"id": "llama-3.3-70b-versatile", "quality": 0.80, "cost": 0.10, "latency": 0.12},
            {"id": "mixtral-8x7b-32768", "quality": 0.72, "cost": 0.08, "latency": 0.10},
        ),
    },
    "together": {
    ...
    "mistral": {
        ...
        "models": (
            {"id": "mistral-large-latest", "quality": 0.88, "cost": 0.45, "latency": 0.35},
            {"id": "mistral-small-latest", "quality": 0.72, "cost": 0.12, "latency": 0.20},
        ),
    },
    "ollama": {
        ...
        "optional_key": True,
        "models": (
            {"id": "llama3.2", "quality": 0.58, "cost": 0.0, "latency": 0.50},
            {"id": "qwen2.5", "quality": 0.62, "cost": 0.0, "latency": 0.48},
        ),
    },
}
...
def load_catalog() -> list[CatalogEntry]:
    ...
    for provider, spec in merged.items():
        ...
        if not env_names:
            env_names = (f"JEV_LLM_{provider.upper()}_API_KEY",)
...
def resolve_gateway(
    ...
    explicit_catalog = bool(
        chosen_provider or chosen_model or (strategy not in {"named", ""})
    )
